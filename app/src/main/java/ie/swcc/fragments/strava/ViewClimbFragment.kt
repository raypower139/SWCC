...
class ViewClimbFragment : Fragment(), AnkoLogger {

    lateinit var app: SWCCApp
    lateinit var loader : AlertDialog
    lateinit var root: View
    var viewPost: ClimbModel? = null
    ...
    override fun onCreateView(
        ...
        root.viewBlogTitle.setText(viewPost!!.LastUpdated)
        root.viewBlogBody.setText(viewPost!!.LastUpdated)
...
//        else
    ...
    companion object {
        @JvmStatic
        fun newInstance(post: ClimbModel) =
            ViewClimbFragment().apply {
